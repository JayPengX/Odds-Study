...
- **Look up any player:** type a number from 1 to 100,020 (a birthday, a lucky number) or draw one at random. That person's season is replayed exactly on the device, with a small chart, their story, their 百分位 as a % beside their number (the share of the crowd they finished ahead of), and their highest and lowest running total (and the week of each). The numbers in the stories are clickable too.
